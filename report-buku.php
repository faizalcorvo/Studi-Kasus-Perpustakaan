...
$query = "SELECT * FROM tblbuku"; // Tampilkan semua data transaksi diurutkan berdasarkan tanggal
// session start
if (!empty($_SESSION)) {
} else {
    session_start();
                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                                    ...
                                    <tbody>
                                        ...
                                        if ($row > 0) { // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                                            while ($data = mysqli_fetch_array($sql)) { // Ambil semua data dari hasil eksekusi $sql
                                                $tgl = date('d-m-Y', strtotime($data['id_buku']));
                                        ?>
                                                <tr>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="table-book.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.invoice -->
